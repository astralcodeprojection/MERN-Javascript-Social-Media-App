        ...
        <div className='w-[70%] h-[70%] flex'>
            ...
            <div className='flex flex-col justify-center' style={{ flex: 1 }}>
                <div className='bg-white h-[400px] p-[20px] rounded-md flex flex-col justify-between shadow-lg'>
                    ...
                    <button className='h-[50px] rounded-lg bg-purple-500 hover:bg-purple-700 transition text-white text-lg font-bold'>Sign Up</button>
                    <button className='h-[50px]  w-1/2 rounded-lg bg-blue-500 hover:bg-blue-700 transition text-white text-lg font-bold self-center'>Log In</button>
                </div>
            </div>
        </div>
    </div>
